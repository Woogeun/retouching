...
def layer_type1(layer_input, in_dimension, out_dimension):
...
def layer_type2(layer_input, in_out_dimension):
...
def layer_type3(layer_input, in_dimension,out_dimension):
...
def layer_type4(layer_input, hw_size, in_dimension, out_dimension):
...
#input Nx256x256x1
L1_T1 = layer_type1(x1,1,int(64*channel_scale))
L2_T1 = layer_type1(L1_T1,int(64*channel_scale),int(16*channel_scale))

L3_T2 = layer_type2(L2_T1,int(16*channel_scale))
L4_T2 = layer_type2(L3_T2,int(16*channel_scale))
L5_T2 = layer_type2(L4_T2,int(16*channel_scale))
L6_T2 = layer_type2(L5_T2,int(16*channel_scale))
L7_T2 = layer_type2(L6_T2,int(16*channel_scale))

L8_T3 = layer_type3(L7_T2,int(16*channel_scale),int(16*channel_scale)) #128x128
L9_T3 = layer_type3(L8_T3,int(16*channel_scale),int(64*channel_scale)) #64x64
L10_T3 = layer_type3(L9_T3,int(64*channel_scale),int(128*channel_scale)) #32x32
L11_T3 = layer_type3(L10_T3,int(128*channel_scale),int(256*channel_scale)) #16x16
# print(L11_T3)

L12_T4 = layer_type4(L11_T3,[16,16],int(256*channel_scale),int(512*channel_scale))
# print(L12_T4)
